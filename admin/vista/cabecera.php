...
<body>
    <?php 
    $url="http://".$_SERVER['HTTP_HOST']."/siteweb"
    ?>
<nav class="navbar navbar-expand navbar-light bg-primary">
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $url; ?>/admin/sesion/producto.php">PRODUCTO0S</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $url; ?>/admin/sesion/producto.php">OFERTAA</a>
            </li>
